        ...
        <>
            ...
            <section class="bg-[#302c42] overflow-hidden pb-9 px-4 md:px-8">
                <header class="flex mx-auto justify-between items-center max-w-[1300px] py-4 ">
                    ...
                    <nav className={`${isOpen ? "block" : "hidden"} md:block`}>
                        <ul className="flex flex-col md:flex-row gap-6 md:gap-10 lg:gap-16">
                            ...
                            <li class="uppercase font-bold text-xs text-white"><Link to="/portfolio">Portfolio</Link></li>
                            {/* <li class="uppercase font-bold text-xs text-white"><a href="#">Contact</a></li> */}
                        </ul>
                    </nav>
                    <div class="hidden sm:flex gap-3 md:gap-5 lg:gap-9">
                        <Link to="/contact">
                            <button class="uppercase font-bold text-xs text-white border-2 border-white rounded-[40px] py-1 px-3  md:py-2 lg:py-4 md:px-4 lg:px-9 ">CONTACT US</button>
                        </Link>
                        <button class="uppercase font-bold text-xm rounded-[40px] py-1 px-3 md:py-2 lg:py-4 md:px-4 lg:px-9 text-[#302c42]  bg-gradient-to-r from-[#8176AF] to-[#C0B7E8]">Hire Me</button>
                    </div>
                ...
                <section
                    ...
                    <div class="md:w-[520px] z-20">
                        <h1 class="text-3xl md:text-[36px] lg:text-[46px] leading-[56px] text-white font-bold">
                            <span class="text-[#C0B7E8]">Hello </span>I'm Raghav Vats
                            <span class="text-[#C0B7E8]"> Full Stack Developer</span></h1>
                        <p class="text-base text-white mt-4 md:mt-9 mb-10 md:mb-16">🚀 Full Stack Developer | Building Scalable & User-Centric Web Applications

                            I am a passionate Full Stack Developer skilled in crafting responsive, high-performance web applications using modern technologies. I specialize in both front-end and back-end development, ensuring seamless user experiences and efficient system design.
                            .</p>
                ...
                {/* <img
                        ...
                        alt="Raghav"
                        className="rounded-3xl w-[300px] h-auto object-cover mx-auto -mt-20 md:-mt-32"
                    /> */}
                <div
                    ...
                    <div class="flex sm:flex-1 gap-4 lg:gap-6"><svg width="42" height="63" viewBox="0 0 42 63" fill="none"
                        ...
                        <div class="text-white">
                            ...
                            <p class="text-sm mt-3">Varanasi, uttarPradesh, 221307, India</p>
                        </div>
                    ...
                    <div class="hidden sm:flex flex-1 gap-4 lg:gap-6"><svg width="51" height="51" viewBox="0 0 51 51" fill="none"
                        ...
                        <div class="text-white">
                            ...
                            <p class="text-sm mt-3">(91+) 6287755372 </p>
                        </div>
                    ...
                    <div class="hidden  lg:flex flex-1 gap-4 lg:gap-6"><svg width="55" height="45" viewBox="0 0 55 45" fill="none"
                        ...
                        <div class="text-white">
                            ...
                            <p class="text-sm mt-3">raghavmishra98601@gmail.com</p>
                        </div>
                    </div>
                </div>
            </section>
